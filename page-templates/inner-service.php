                ...
                <div class="row gy-5 gx-xl-5">
                    ...
                    <div class="col-12 col-md-6 col-lg-5">
                        <div class="bg-primary rounded-20 shadow overflow-hidden">
                            ...
                            <article class="p-4">
                                <p class="fs-27 fw-700 text-tertiary text-capitalize text-end">Experience That Speaks</p>

                                <p class="text-white fs-20 fw-600 pt-3">From controlled implosions to strategic deconstruction, we've done it all, proving our mettle time and again.</p>
                            </article>
                        </div>
                    </div>
                        ...
                        <div class="row bg-primary rounded-20 shadow gx-0 overflow-hidden">
                            ...
                            <div class="col-12 col-lg-6">
                                <article class="p-4">
                                    ...
                                    <p class="fs-20 fw-700 text-white text-capitalize">Uncompromising Safety</p>
                                </article>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-xl-12">
                        <div class="bg-gray shadow overflow-hidden rounded-20">
                            ...
                            <article class="p-4 mx-auto col-xl-10">
                                <p class="fs-27 fw-700 text-primary-dark text-capitalize text-center">Tailored Solutions, Client Satisfaction</p>

                                <p class="fs-20 fw-700 pt-3 text-center">
                                    With open communication and a commitment to turning your vision into reality, we ensure your complete satisfaction throughout the demolition journey.
                                </p>
                            </article>
                        </div>
                    </div>
